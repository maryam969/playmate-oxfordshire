...
const sportGroups = [
  { emoji: "⚽", label: "Football", members: 142, unread: 3, href: "/groups/football" },
  { emoji: "🎾", label: "Tennis", members: 78, unread: 0, href: "/groups/tennis" },
  { emoji: "🏀", label: "Basketball", members: 55, unread: 1, href: "/groups/basketball" },
  { emoji: "🏸", label: "Badminton", members: 41, unread: 0, href: "/groups/badminton" },
  { emoji: "🎾", label: "Padel", members: 29, unread: 4, href: "/groups/padel" },
];
          ...
          {sportGroups.map((group) => (
            ...
            >
              <div className="flex items-center gap-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#ECFDF5] text-2xl">
                  {group.emoji}
                </div>
